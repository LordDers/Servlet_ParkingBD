...
public class ParkingVehiculos {
	...
	public static final void leerVehiculos() {
		// Leer "vehiculos.txt"
		try {
			BufferedReader br2 = new BufferedReader(new FileReader("/home/zubiri/ProyectosJava/GestionesParking2/WebContent/ficheros/vehiculos.txt"));
	...
	public final static void anyadirVehiculosFichero(Coche vehiculo) throws IOException {		
		File TextFile = new File("/home/zubiri/ProyectosJava/GestionesParking2/WebContent/ficheros/vehiculos.txt"); 
	...
	public final static void borrarVehiculosFichero(String matricula) throws IOException {		
		try {
			...
			String file = "/home/zubiri/ProyectosJava/GestionesParking2/WebContent/ficheros/vehiculos.txt";
